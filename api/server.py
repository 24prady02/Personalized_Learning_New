...
from src.knowledge_graph import CSEKGClient, QueryEngine, ConceptRetriever
from src.models.nestor import InterventionRecommender, PersonalityProfiler
...
async def startup_event():
    ...
    try:
        ...
        print("⚠ No HVSAE checkpoint found, using untrained model")
