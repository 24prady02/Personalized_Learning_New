...
- [OK] **0.1** _completely empty_  (1.48s)
...
- [OK] **0.5c** _idk variant 'no clue'_  (0.02s)
    - output: `{"confidence": 0.3, "lp": "L1"}`
- [OK] **0.5d** _idk variant 'no idea'_  (0.01s)
    - output: `{"confidence": 0.3, "lp": "L1"}`
...
- [OK] **2.6** _WM string_equality_  (0.03s)
...
- [OK] **2.8** _WM string_equality_  (0.02s)
...
- [OK] **3.7** _multi-concept differential LP_  (0.04s)
...
- [~] **4.5** _plateau cleared by regression_  (0.02s)
...
- [OK] **5.4** _probe cap constant_  (19.54s)
    - output: `{"cap": 8}`
...
- [OK] **19.1** _DBStore upsert+read roundtrip_  (0.01s)
    - output: `{"stored": [0.42, "2026-05-22T02:56:20+00:00"]}`
