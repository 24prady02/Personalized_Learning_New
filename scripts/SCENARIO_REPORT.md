...
- [OK] **0.1** _completely empty_  (2.49s)
    - output: `{"resolved": [["unknown", 0.0]], "stage": 1}`
- [OK] **0.2** _whitespace-only_  (0.0s)
    - output: `{"resolved": [["unknown", 0.0]]}`
- [OK] **0.3a** _single token '?'_  (0.1s)
    - output: `{"top": "unknown", "encoding_strength": "partial"}`
- [OK] **0.3b** _single token '😭'_  (0.05s)
    - output: `{"top": "unknown", "encoding_strength": "partial"}`
- [OK] **0.3c** _single token '.'_  (0.05s)
    - output: `{"top": "unknown", "encoding_strength": "partial"}`
- [OK] **0.3d** _single token 'k'_  (0.05s)
    - output: `{"top": "unknown", "encoding_strength": "partial"}`
- [OK] **0.5a** _idk variant 'idk'_  (0.06s)
    - output: `{"confidence": 0.3, "lp": "L1"}`
- [OK] **0.5b** _idk variant "i don't know"_  (0.04s)
    - output: `{"confidence": 0.3, "lp": "L1"}`
- [OK] **0.5c** _idk variant 'no clue'_  (0.04s)
    - output: `{"confidence": 0.3, "lp": "L1"}`
...
- [OK] **0.10** _text only no actions_  (0.06s)
...
- [OK] **1.12** _detect boolean_operators_  (0.02s)
...
- [OK] **1.14** _detect unreachable_code_  (0.02s)
...
- [OK] **1.17** _detect static_vs_instance_  (0.02s)
...
- [OK] **1.27** _off-topic_  (0.02s)
    - output: `{"top": "unknown"}`
- [OK] **1.28** _out-of-catalogue concept_  (0.03s)
    - output: `{"top": "unknown"}`
- [OK] **1.29** _ambiguous concepts_  (0.05s)
...
- [OK] **2.2** _WM null_pointer_  (0.07s)
...
- [OK] **2.8** _WM string_equality_  (0.05s)
...
- [OK] **3.7** _multi-concept differential LP_  (0.08s)
...
- [OK] **4.1** _first L2_  (0.05s)
    - output: `{"plateau_flag": false, "lp": "L1"}`
- [OK] **4.2** _second L2 → plateau_  (0.05s)
...
- [OK] **7.1** _trial-and-error_  (0.04s)
    - output: `{"top": "unknown", "stage": 1}`
- [OK] **7.2** _systematic debug_  (0.03s)
    - output: `{"top": "unknown", "stage": 1}`
- [OK] **7.3** _long pause stuck_  (0.04s)
    - output: `{"top": "unknown", "stage": 1}`
...
- [~] **8.1** _cold-start prior_  (0.0s)
    ...
    - output: `{"prior": 0.15}`
- [OK] **8.2** _5x correct climbs_  (0.01s)
    - output: `{"after": 0.99}`
...
- [OK] **9.4** _no code text only_  (0.03s)
    - output: `{"top": "unknown", "conf": 0.0}`
...
- [OK] **14.1** _extremely long input_  (0.05s)
    - output: `{"top": "unknown"}`
...
- [OK] **18.4** _breakthrough → growth_efficacy_  (0.04s)
    - output: `{"self_efficacy": "growth", "attribution": "neutral"}`
- [OK] **18.5** _prolonged grind → high_anxiety_  (0.04s)
    - output: `{"high_anxiety": true}`
- [OK] **18.6** _WM threshold boundary_  (0.06s)
    - output: `{"wm": null, "score": 0.0}`
- [OK] **18.7** _substance penalty fires on 2 tokens_  (0.1s)
    - output: `{"confidence": 0.3}`
...
- [OK] **18.12** _essay reply → solid/deep encoding_  (0.05s)
