...
try:
    ...
    # torch_geometric not installed — stub out so the rest of the
    # codebase can import this module without crashing.
    _TORCH_GEOMETRIC_AVAILABLE = False
    class GCNConv(object): pass
    class GATConv(object): pass
