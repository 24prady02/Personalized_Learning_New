...
class RealMetricsCalculator:
    ...
    def __init__(self, config: Dict):
        ...
        try:
            ...
            print("[Metrics] [OK] CodeBERT model loaded for code analysis")
        except Exception as e:
            print(f"[Metrics] [WARN] CodeBERT loading failed: {e}")
        ...
        try:
            ...
            print("[Metrics] [OK] BERT model loaded for text quality")
        except Exception as e:
            print(f"[Metrics] [WARN] BERT loading failed: {e}")
